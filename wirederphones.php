...
<source src="wired/vdo1.mp4" type="video/mp4">
</video>
...
<video autoplay muted loop class="promo-video">
<source src="wired/vdo2.mp4" type="video/mp4">
</video>

</section>

<div class="wired-products">

<?php
$conn = mysqli_connect("localhost","root","","mywebsite");

$query = "SELECT * FROM product WHERE category='wiredheadphone'";
